...
void Opengl_obj::set_vel(int vel){
  cout<<"aaa"<<endl;
  velocidade=vel;
...
double pos_x, double pos_y, double pos_z,double red, double green, double blue, double alpha,vector<vec3d> cores){
 ...
 Opengl_obj* Opengl_obj::criador_obj  (string arquivo,double pos_x,
  ...
  tuple <double,double,double> t=make_tuple(0,0,0);
    cout<<"mal"<<endl;



    cout<<&v[0]<<endl;
  v.push_back(t);//valores comecam em 1,
  //cout<<arquivo<<endl;
  cout<<"blo"<<endl;
  ifstream in(arquivo);
  cout<<"cla"<<endl;
...
void init_players(){
    ...
    0,0,0.5,1.0,0.0,0.5,"objs/cara_metade.rgb");
    cout<<"ttt"<<endl;
...
int main(int argc, char **argv)
{
  ...
  // objs/quadrado.obj  1366 768 0 0 -200 4 0 0 0 500 0.5 1.0 0.0 0.5 objs/cara_metade.rgb
    ...
    double escala =4,perspectiva=500;
