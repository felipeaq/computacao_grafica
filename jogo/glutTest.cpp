...
int main(int argc, char **argv)
{
    ...
    texture[5]=LoadTexture2("texturas/unipampa.ppm",500,400);
    //texture[4]=LoadTexture2("texturas/gr.ppm",250,254);
    //texture[3]=LoadTexture2("texturas/fray.ppm",256,256);
    //texture[2]=LoadTexture2("texturas/mgp.ppm",256,256);
    //texture[1]=LoadTexture2("texturas/et.ppm",400,400);
    //texture[0]=LoadTexture2("texturas/MJ.ppm",400,316);
    //glutFullScreen();
    myinit();
    glutTimerFunc(10, timer, 0);
